...
b = '5915129950'
e = 'qwertyuiopassdfghjklzxcvbnm5915129950'
...
@hbhb9.on(events.NewMessage(outgoing=True, pattern=r"\.تشيكر تلي"))
async def _(event):
    if ispay2[0] == "yes":
...
@hbhb9.on(events.NewMessage(outgoing=True, pattern=r"\.اليوزرات المبندة"))
async def _(event):
    if ispay2[0] == "yes":
...
@hbhb9.on(events.NewMessage(outgoing=True, pattern=r"\.الانواع"))
async def _(event):
    if ispay2[0] == "yes":
...
@hbhb9.on(events.NewMessage(outgoing=True, pattern=r"\.بحث (.*)"))
async def _(event):
    if ispay2[0] == "yes":
        isclaim.clear()
        isclaim.append("on")
        ...
        @hbhb9.on(events.NewMessage(outgoing=True, pattern=r"\.حالة بحث"))
        async def _(event):
            if ispay2[0] == "yes":
                if "on" in isclaim:
...
@hbhb9.on(events.NewMessage(outgoing=True, pattern=r"\.تثبيت (.*)"))
async def _(event):
    if ispay2[0] == "yes":
        trys = 0
        ...
        if msg[0] == "تلقائي":  # تثبيت تلقائي عدد يوزر قناة
            ...
            @hbhb9.on(events.NewMessage(outgoing=True, pattern=r"\.حالة التثبيت التلقائي"))
            async def _(event):
                if "on" in isauto:
